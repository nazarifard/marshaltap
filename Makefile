...
structdef-bebop-wellquite.go: structdef-bebop-wellquite.bop
	go run wellquite.org/bebop/cmd/bebop -i ./structdef-bebop-wellquite.bop -o ./structdef-bebop-wellquite.go -p github.com/nazarifard/go_serialization_benchmarks/goserbench
